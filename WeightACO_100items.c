...
inter=k;
  ...
  if(strcmp(argv[1],"pymoo\\dataset\\mood_train_dataset\\dataset_0_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_train_dataset_0.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_train_dataset\\dataset_1_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_train_dataset_1.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_train_dataset\\dataset_2_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_train_dataset_2.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_train_dataset\\dataset_3_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_train_dataset_3.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_train_dataset\\dataset_4_instance_100_items_3_objectifs.txt")==0){
