...
inter=k;
	...
	FILE *fpareto;
  if(strcmp(argv[1],"pymoo\\dataset\\mood_val_dataset\\dataset_0_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_val_dataset_0_100_items.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_val_dataset\\dataset_1_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_val_dataset_1_100_items.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_val_dataset\\dataset_2_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_val_dataset_2_100_items.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_val_dataset\\dataset_3_instance_100_items_3_objectifs.txt")==0){
	fpareto = fopen( "results_val_dataset_3_100_items.txt", "a+" );}

  if(strcmp(argv[1],"pymoo\\dataset\\mood_val_dataset\\dataset_4_instance_100_items_3_objectifs.txt")==0){
